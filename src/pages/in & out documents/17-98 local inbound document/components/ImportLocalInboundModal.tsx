...
import useLocalInboundImport from "@/pages/in & out documents/17-98 local inbound document/hooks/useLocalInboundImport.ts";
...
export default ImportLocalInboundModal;

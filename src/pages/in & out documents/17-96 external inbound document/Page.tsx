...
import useExternalInbounds
    from "@/pages/in & out documents/17-96 external inbound document/hooks/useExternalInbounds.ts";
            ...
            <PageHeader className={"sticky top-0"} breadcrumbs={breadcrumbs}>
                <div className="flex items-center gap-2">
                    ...
                    >
                        ...
                        {t("O'chirish")} {selectedRowKeys.length > 0 && `(${selectedRowKeys.length})`}
                    </Button>

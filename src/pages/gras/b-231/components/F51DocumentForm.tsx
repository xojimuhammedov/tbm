...
import { ApplicationDto } from "@/pages/rtsi/application/schemas/createApplicationSchema";
...
const F56DocumentForm = ({ id, onSave }: F51DocumentFormProps) => {
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="p-4">
        <div className="w-full max-w-7xl mx-auto p-4">
          <h1 className="text-lg font-bold text-center mb-4">
            Каналлар учун айланиб ўтишлар ва алмаштиришлар графикларининг
            рўйҳати
          </h1>
          <div className="text-right mb-2 text-sm">3.2 «а»-шакл</div>

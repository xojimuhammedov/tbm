...
const createFlowColumns = (
  ...
  },
  {
    key: "flow_code",
    dataIndex: "flow_code",
    name: renderHeader("ID"),
    render: renderCell,
  },
  {
    key: "forward",
    dataIndex: "forward",
    name: renderHeader(t("прямой")),
    render: renderCell,
  },
  {
    key: "reverse",
  ...
  },
  {
    key: "start",
    dataIndex: "start",
    name: renderHeader(t("Начало")),
    render: renderCell,
  },
  {
    key: "port_a",
    dataIndex: "port_a",
    name: renderHeader("Port A"),
    render: renderCell,
  },
  {
    key: "mux_a",
    dataIndex: "mux_a",
    name: renderHeader("Mux A"),
    render: renderCell,
  },
  { key: "pa", dataIndex: "pa", name: renderHeader("пА"), render: renderCell },
  {
    key: "final_ms_name",
    dataIndex: "final_ms_name",
    name: renderHeader("Name MS final"),
    render: renderCell,
  },
  {
    key: "signal_level",
    dataIndex: "signal_transmission_level",
    name: renderHeader(t("Уровень п")),
    render: renderCell,
  },
  {
    key: "au4",
    dataIndex: "au4",
    name: renderHeader("AU-4"),
    render: renderCell,
  },
  ...
  { key: "pb", dataIndex: "pb", name: renderHeader("пВ"), render: renderCell },
  {
    key: "transit",
    dataIndex: "transit",
    name: renderHeader(t("транзит")),
    render: renderCell,
  },
  {
    key: "mux_b",
    dataIndex: "mux_b",
    name: renderHeader("Mux B"),
    render: renderCell,
  },
  {
    key: "port_b",
    dataIndex: "port_b",
    name: renderHeader("Port B"),
    render: renderCell,
  },
  {
    key: "end",
    dataIndex: "end",
    name: renderHeader(t("Конец")),
    render: renderCell,
  },
  {
    key: "consumer",
    dataIndex: "consumer",
    name: renderHeader(t("Пoтребитель")),
    render: renderCell,
  },
  {
    key: "order_number",
    dataIndex: "order_number",
    name: renderHeader(t("Распоряжения")),
    render: renderCell,
  },
  {
    key: "interest_level",
    dataIndex: "interest_level",
    name: renderHeader(t("Заинтересованность")),
    render: renderCell,
  },
  { key: "mt", dataIndex: "mt", name: renderHeader("М/Т"), render: renderCell },
  {
    key: "speed",
    dataIndex: "speed",
    name: renderHeader(t("Скорость")),
    render: renderCell,
  },
  {
    key: "protection_mode",
    dataIndex: "protection_mode",
    name: renderHeader(t("Prot/Unprot")),
    render: renderCell,
  },
  {
    key: "sp",
    dataIndex: "sp",
    name: renderHeader(t("С/П")),
    render: renderCell,
  },
  {
    key: "additional_information",
    dataIndex: "additional_information",
    name: renderHeader(t("Дополнительная Информация")),
    render: renderCell,
  },
  {
    key: "payment_status",
    dataIndex: "payment_status",
    name: renderHeader(t("оплата")),
    render: renderCell,
  },
  {
    key: "e1_name_in_vs",
    dataIndex: "e1_name_in_vs",
    name: renderHeader(t("ИМя_е1_в_ВС")),
    render: renderCell,
  },
  {
    key: "ms_name_in_vs",
    dataIndex: "ms_name_in_vs",
    name: renderHeader(t("ИМя_MS_в_ВС")),
    render: renderCell,
  },
  {
    key: "actions",

...
import useRTTSIDocumentForm from "@/pages/rttsi/hooks/useRTTSIDocumentForm.ts";
import { Button } from "dgz-ui/button";
import { RTTSIDto } from "@/pages/rttsi/schemas/createRTTSISchema.ts";
...
interface RTTSIDocumentFormProps {
  id?: string | null;
  onSave?: () => void;
  onCancel?: () => void;
}

const RTTSIDocumentForm = ({
  id,
  onSave,
  onCancel,
}: RTTSIDocumentFormProps) => {
  const { t } = useTranslation();
  const { staffOptions } = useStaffOptions();
  const { form, handleSubmit } = useRTTSIDocumentForm({
    id,
    onSave,
  });
        ...
        <div className="max-w-5xl mx-auto px-2">
          <div className="rounded-lg shadow-sm border-2 p-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-3">{t("(Majburiy)")}</p>
            ...
            <div className="text-center mb-6">
              <div className="flex justify-center items-center gap-4 mb-3">
                ...
                <div className="mt-2">{t("UBPdan")}</div>
              </div>
              <div className="mb-2">
                {t(
              ...
              <div className="flex justify-center items-center gap-4 mb-3">
                ...
                />
                <div className="mt-2"> - {t("son TALABNOMA")}</div>
              </div>
            </div>
            ...
            <div className="space-y-2 px-2">
              ...
              <div className={"flex items-center gap-2"}>
                <label className="mt-4">3. {t("Uchastka, stansiyalar")}</label>
                <div className={"flex-1"}>
                  <MyInput<RTTSIDto>
                    control={form.control}
                    className={
              ...
              <div className={"flex items-center gap-2"}>
                <label className="mt-4">4. {t("NO nomeri")}</label>
                <div className={"flex-1"}>
                  <MyInput<RTTSIDto>
                    control={form.control}
                    className={
              ...
              <div className={"flex items-center gap-2"}>
                <label className="mt-4">5. {t("Al-9 kanallari")}</label>
                <div className={"flex-1"}>
                  <MyInput<RTTSIDto>
                    control={form.control}
                    className={
              ...
              <div className={"flex items-center gap-2"}>
                <label className="mt-4">8. {t("NO holati")}</label>
                <div className={"flex-1"}>
                  <MyInput<RTTSIDto>
                    control={form.control}
                    className={
              ...
              <div className={"flex items-center gap-2"}>
                <label className="mt-4">9. {t("AAG")}</label>
                <div className={"flex-1"}>
                  <MyInput<RTTSIDto>
                    control={form.control}
                    className={
              ...
              <div className={"flex items-center gap-2"}>
                <label className="mt-4">11. {t("Rahbar stantsiyasi")}</label>
                <div className={"flex-1"}>
                  <MyInput<RTTSIDto>
                    control={form.control}
                    className={
              ...
              <div className={"flex items-center gap-2"}>
                <label className="mt-4">12. {t("Kelishilgan")}</label>
                <div className={"flex-1"}>
                  <MyInput<RTTSIDto>
                    control={form.control}
                    className={
              ...
              <div className={"flex items-center gap-2"}>
                <label className="mt-4">13. {t("Kelishilgan")}</label>
                <div className={"flex-1"}>
                  <MyInput<RTTSIDto>
                    control={form.control}
                    className={
              ...
              <div className={"flex items-center gap-2"}>
                ...
                <div className={"flex-1"}>
                  <MyInput<RTTSIDto>
                    ...
                    name="applicantAP"
                    placeholder={t("Talabnomaning sanasi, vaqti, raqami")}
                  />
                </div>
              </div>
          ...
          <div className={"mt-6"}>
            <FilePondComponent
              labelIdle={t("Qo'shimcha biriktrilgan fayllar")}
              allowProcess={false}
              instantUpload
              maxFiles={1}
              docType={"f56"}
...
export default RTTSIDocumentForm;

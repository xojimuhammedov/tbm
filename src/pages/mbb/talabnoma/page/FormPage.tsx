...
import { Form, MyInput, MySelect, MyDatePicker, MyTextarea } from "dgz-ui-shared/components/form";
import { ArrowLeftIcon, Plus, Trash2 } from "lucide-react";
import useTalabnomaForm from "@/pages/mbb/talabnoma/hooks/useTalabnomaForm.ts";
...
import { TalabnomaDto } from "../schemas/createTalabnomaSchema";

const ApplicationBlock = ({ control, index, removeApplication }: { control: Control<TalabnomaDto>, index: number, removeApplication: (i:number) => void }) => {
  ...
  return (
    <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 flex flex-col gap-3 relative">
      ...
      <div className="pt-2">
        <label className="text-xs font-semibold text-gray-500 mb-2 block">Oraliqlar (Ranges)</label>
...
const TalabnomaPage = () => {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="p-4 bg-gray-50/50 min-h-screen">
        <div className="w-full max-w-5xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="space-y-6 text-[15px]">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900">1. Ish olib borish sharti:</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] gap-4">
              <label className="font-semibold md:w-56 text-gray-900 mt-2">2. Sana:</label>
            ...
            {/* 3 */}
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900">3. Uchastka, stansiya:</label>
              <div className="flex-1 max-w-2xl">
                <MyInput
                   name="station"
                   control={form.control}
            ...
            {/* 4 */}
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900">4. NO raqami:</label>
              <div className="flex-1 max-w-2xl">
                <MyInput
                   name="no_number"
                   control={form.control}
            ...
            <div className="ml-0 md:ml-60 border-l-[3px] border-indigo-200 pl-6 py-2 space-y-4 max-w-2xl">
               <div className="flex items-center justify-between mb-2">
                 <h4 className="text-[15px] font-bold text-indigo-900">Kanallar ilovasi (Array):</h4>
                 <Button
                    type="button"
                    className="h-8 text-xs font-semibold text-indigo-700 border-indigo-200 hover:bg-indigo-50"
                    onClick={() => appendApplication({ operator_name: "", ranges: [{from: "", to: ""}] })}
                  >
            ...
            {/* 5 */}
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900">5. AI kanallari:</label>
              <div className="flex-1 max-w-2xl">
                <MyInput
                   name="ai_channel"
                   control={form.control}
            ...
            <div className="flex gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900 mt-2">6.</label>
              <div className="flex-1 max-w-2xl">
                <MyTextarea
                   name="reason_work"
                   control={form.control}
            ...
            {/* 7 */}
            <div className="flex gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900 mt-2">7.</label>
              <div className="flex-1 max-w-2xl">
                <MyTextarea
                   name="content_work"
                   control={form.control}
            ...
            {/* 8 */}
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900">8. NO xolati:</label>
              <div className="flex-1 max-w-2xl">
                <MyInput
                   name="no_status"
                   control={form.control}
            ...
            {/* 9 */}
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900">9. AvaO‘J:</label>
              <div className="flex-1 max-w-2xl">
                <MyInput
                   name="aoj_number"
                   control={form.control}
            ...
            {/* 10 */}
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900">10.</label>
              <div className="flex-1 max-w-2xl">
                <MyInput
                   name="reverse"
                   control={form.control}
            ...
            {/* 11 */}
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900">11. Boshqaruv stansiyasi:</label>
              <div className="flex-1 max-w-2xl">
                <MyInput
            ...
            {/* 12 */}
            <div className="flex gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900 mt-2">12. Kelishildi:</label>
              <div className="flex-1 max-w-2xl">
                <MyTextarea
                   name="agreed"
                   control={form.control}
            ...
            {/* 13 */}
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900">13. Kelishildi:</label>
              <div className="flex-1 max-w-2xl">
                <MyInput
                   name="ai_agreed"
                   control={form.control}
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 pt-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900">14. Talabnoma tuzuvchi (IP):</label>
            ...
            {/* 15 */}
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <label className="font-semibold whitespace-nowrap md:w-56 text-gray-900">15. Talabnoma tuzuvchi (MBB-1):</label>
              <div className="flex-1 max-w-2xl flex items-center gap-4">
                <MyInput
                   name="creator_mbb"
                   control={form.control}

...
const createNotifyColumns = (
  ...
  {
    key: "nomenclature_number",
    dataIndex: "nomenclature_number",
    name: t("Raqami"),
  },
  {
    key: "doc_recipient",
    dataIndex: "doc_recipient",
    name: t("Hujjat oluvchi"),
  },
  {
    key: "signed_by",
    dataIndex: "signed_by",
...
export default createNotifyColumns;
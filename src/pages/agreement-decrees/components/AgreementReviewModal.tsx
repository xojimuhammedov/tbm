...
const statusColors: Record<string, "red" | "orange" | "green" | "gray" | "default"> = {
    IN_REVIEW: "orange",
    ACCEPTED: "green",
    REJECTED: "red",
    PENDING: "orange",
        ...
        >
            ...
            <Dialog open={isRejectModalOpen} onOpenChange={setIsRejectModalOpen}>
                <DialogContent>
                    ...
                    <DialogFooter>
                        <Button variant="secondary" onClick={() => setIsRejectModalOpen(false)} disabled={isPending}>
                            Bekor qilish
                        </Button>
                        <Button
                            variant="destructive"
            ...
            <Dialog open={isApproveModalOpen} onOpenChange={setIsApproveModalOpen}>
                <DialogContent>
                    ...
                    <DialogFooter>
                        <Button variant="secondary" onClick={() => setIsApproveModalOpen(false)} disabled={isPending}>
                            Yo'q
                        </Button>
                        <Button
                            className="bg-green-600 hover:bg-green-700 text-white"

    ...
    async (
      ...
      try {
        ...
        toast({
          ...
          description: t("Yangi ishtirokchi qo'shildi"),
        });
      } catch {
        toast({
          variant: "destructive",
          title: t("Xatolik"),
          description: t("Ishtirokchi qo'shishda xatolik yuz berdi"),
        });
      }
    },
    ...
    async (targetId: string) => {
      ...
      try {
        ...
        toast({
          variant: "success",
          title: t("Muvaffaqiyatli"),
          description: t("Ishtirokchi olib tashlandi"),
        });
      } catch {
        toast({
          variant: "destructive",
          title: t("Xatolik"),
          description: t("Olib tashlashda xatolik yuz berdi"),
        });
      }
    },

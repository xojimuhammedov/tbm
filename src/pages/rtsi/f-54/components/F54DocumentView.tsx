...
import F54Document from "@/pages/rtsi/f-54/components/F54Document.tsx";
import { useTranslation } from "react-i18next";

interface F54DocumentViewProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  document?: F54DocumentInterface;
}

const F54DocumentView = ({
  open,
  onOpenChange,
  document,
}: F54DocumentViewProps) => {
...
export default F54DocumentView;

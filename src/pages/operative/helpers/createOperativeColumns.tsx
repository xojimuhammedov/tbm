...
const statusVariant = (status: OperativeDocumentInterface["status"]) => {
  switch (status) {
    case "approved":
...
const createOperativeColumns = (
  t: (...args: TranslationArgsType) => string,
  handleEdit: (id: string) => void,
  handleDelete: (id: string) => void,
  handleView: (id: string) => void,
): ColumnType<OperativeDocumentInterface>[] => [
  {
    key: "title",
    dataIndex: "title",
    name: t("Document"),
...
export default createOperativeColumns;

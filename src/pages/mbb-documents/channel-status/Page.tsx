...
import useChannelStatusList from "./hooks/useChannelStatusList";
...
const Page = () => {
  ...
  return (
    <>
      ...
      <PageWrapper>
        <DataTable<
          ChannelStatusDocument,
          PaginationInterface<ChannelStatusDocument>
        >
          tableKey={CHANNEL_STATUS_QUERY_KEY}
          hasNumbers
          hasSearch
          isStickyHeader
          hasPagination

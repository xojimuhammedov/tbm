...
import useTelecomOperativeList from "./hooks/useTelecomOperativeList";
...
const Page = () => {
  ...
  return (
    <>
      ...
      <PageWrapper>
        <DataTable<TelecomOperativeDocument, PaginationInterface<TelecomOperativeDocument>>
          tableKey={TELECOM_OPERATIVE_QUERY_KEY} hasNumbers hasSearch isStickyHeader hasPagination

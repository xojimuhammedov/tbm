...
import useChannelsImport from "@/pages/channels-id/hooks/useChannelsImport.ts";
...
const ImportChannelsModal = ({ open, onOpenChange, refetch }: ImportFlowModalProps) => {
    ...
    const { handleUpload, loading } = useChannelsImport({
        status,
        onSuccess: () => {
            setProgress(100);
            setTimeout(() => {

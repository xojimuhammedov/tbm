...
const statusVariant = (status: F54DocumentInterface["status"]) => {
  switch (status) {
    case "approved":
...
const createF54Columns = (
  t: (...args: TranslationArgsType) => string,
  handleEdit: (id: string) => void,
  handleDelete: (id: string) => void,
  handleView: (id: string) => void,
): ColumnType<F54DocumentInterface>[] => [
  {
    key: "channel_id",
  ...
  },
  {
    ...
    name: t("Ishlarni o'tkazishning haqiqiy vaqti"),
  },
  {
    key: "description",
...
export default createF54Columns;

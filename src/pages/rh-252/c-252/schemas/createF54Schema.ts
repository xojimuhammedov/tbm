...
export const createF54Schema = (t: (...args: TranslationArgsType) => string) =>
  z.object({
    ...
    real_minutes: z.string().nonempty(
      t("required {{field}}", {
        field: t("Minute"),
        ns: config.LANG.NS.VALIDATION,
      }),
...
export type F54Dto = z.infer<ReturnType<typeof createF54Schema>>;

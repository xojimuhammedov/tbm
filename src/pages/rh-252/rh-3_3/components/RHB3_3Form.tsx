      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="p-4">
        <div className="w-full max-w-7xl mx-auto p-4">
          <h1 className="text-2xl font-bold text-center mb-4">
            {t("«ЎзТТБРМ» ДУК фармойишлари бажарилганлиги тўғрисида маълумот шакли")}
          </h1>
          <div className="flex flex-col mb-6">
            <p className="text-center text-sm">
              {t("«ЎзТТБРМ» ДУКнинг алоқалари шакллантириш/тугатиш/қайта шакллантириш/блокировкалаш/блокдан чиқариш бўйича фармойишларининг бажарилиши тўғрисида")} <br />
            </p>
            ...
            {fields.map((field, index) => (
              <tr key={field.id} className="hover:bg-gray-50">
                ...
                <td className="border border-gray-300 px-2 py-2">
                  <MyInput
                    control={form.control}
                    name={`data.${index}.specifiedDeadline`}
                ...
                <td className="border border-gray-300 px-2 py-2">
                  <MyInput
                    control={form.control}
                    name={`data.${index}.actualCompletion`}
                    className="border-0 border-b border-gray-300 rounded-none focus-visible:ring-0"
                ...
                <td className="border border-gray-300 px-2 py-2">
                  <MyInput
                    control={form.control}
                    name={`data.${index}.responsibleExecutor`}
                    className="border-0 border-b border-gray-300 rounded-none focus-visible:ring-0"
                ...
                <td className="border border-gray-300 px-2 py-2">
                  <MyInput
                    control={form.control}
                    name={`data.${index}.customerDetails`}
                    className="border-0 border-b border-gray-300 rounded-none focus-visible:ring-0"
...
export default RHB3_3Application;

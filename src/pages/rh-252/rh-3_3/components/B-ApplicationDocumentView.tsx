        ...
        >
          ...
          <div className="text-center mb-6">
            <h2 className="font-bold text-[16px] uppercase">
              «UzTTBRM» DUK farmoyishlari bajarilganligi to‘g‘risida ma’lumot
              shakli
            </h2>
            ...
            <table className="w-full border-collapse border-[1.5px] border-black text-[11px]">
              <thead>
                <tr className="bg-gray-50 text-center">
                  ...
                  <th className="border-[1.5px] border-black p-1 leading-tight">
                    Iste’molchi (aloqani qabul qilgan iste’molchining
                    familiyasi)
                  </th>
                  <th className="border-[1.5px] border-black p-1 leading-tight">
              ...
              <tbody>
                ...
                {[2, 3].map((i) => (
                  <tr key={i} className="h-10">
                    <td className="border-[1.5px] border-black text-center">
                      {i}
                    </td>
                    {Array(7)
                      .fill(0)

        ...
        >
            <div className="py-10 px-4 flex justify-center bg-gray-100 min-h-screen">
                ...
                >
                    ...
                    <div className="flex justify-between font-bold border-b border-black py-1 mb-6 text-[14px]">
                        <div>
                            SANA:{" "}
                ...
                {document?.order_date ? dateFormatter(document.order_date, "yyyy-yil d-MMMM") : "____-yil __-________"}
                        ...
                        <div>№ {document?.code || "17-54"}-{document?.document_index || "____"}/2026</div>
                        <div>SONI: 1</div>
                    </div>
                    <div className="grid grid-cols-[100px_1fr] gap-y-2 mb-8 text-[15px]">
                        ...
                        <div className="font-bold uppercase">
                            {document?.to?.length ? document.to.map((item, i) => (
                                <p key={i}>“O‘zbektelekom” AK {item}</p>
                            )) : "________________"}
                        </div>
                    ...
                    <div className="text-center font-bold text-[16px] mb-8 uppercase underline">
                    ...
                    <div className="text-[15px] text-justify space-y-4 mb-6 leading-relaxed">
                        <p className="indent-12">
                            ...
                            {payload?.basic?.request_date ? dateFormatter(payload.basic.request_date, "yyyy-yil d-MMMMdagi") : "____-yil __-________dagi"}{" "}
                        ...
                        <table className="w-full border-collapse border border-black text-[14px]">
                            ...
                            {payload?.events?.map((event: any, eventIdx: number) => (
                                <tr key={eventIdx}>
                                    ...
                                    <td className="border border-black p-3 w-1/6 text-center align-middle font-bold underline">
                    ...
                    <div className="mt-20 flex justify-between items-end px-4">
                        <div className="w-1/3 italic">
                            <p className="font-bold uppercase text-[14px] not-italic">Boshliq</p>
                        </div>
                        <div className="w-1/3 border-b border-black mb-1 mx-4 text-center text-[11px] text-gray-400">
                            (imzo)
                        </div>

        ...
        >
          ...
          <div className="flex justify-between font-bold py-1 mb-6 text-[14px]">
            <div>
              ...
              <span className="">
                {document?.order_date
                  ? dateFormatter(document.order_date, "YYYY-MM-DD")
          ...
          <div className="text-[15px] text-justify space-y-4 mb-6 leading-relaxed">
            <p className="indent-12">
              ...
              {payload?.basic?.request_date
                ? dateFormatter(payload.basic.request_date, "YYYY-yil DD-MMMM")
                        ...
                        <tbody className="h-full">
                          {event.schedule?.map((item: any, itemIdx: number) => (
                            ...
                            >
                              ...
                              <td
                                className={`p-2 text-center ${item.event_type === "Jonli efir" ? "font-bold" : ""}`}
                              >
                                {item.event_type}
                              </td>
                            </tr>

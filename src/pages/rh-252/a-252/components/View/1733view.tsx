        ...
        >
          ...
          <div className="flex justify-between items-start mb-10 pb-6">
            ...
            <div className="w-2/3 text-right flex flex-col gap-2">
              ...
              <div className="text-[11px] font-bold text-blue-900 italic leading-tight">
                “Republican telecommunications management center of
                <br />
          ...
          <div className="flex justify-between font-bold py-1 mb-6 text-[14px] border-b border-black pb-2">
            <div>
              SANA:{" "}
              {document?.order_date
                ? dateFormatter(document.order_date, "YYYY-yil DD-MMMM")
          ...
          <div className="text-[15px] text-justify space-y-4 mb-6 leading-relaxed">
            <p className="indent-12">
              ...
              {basic?.request_date
                ? dateFormatter(basic.request_date, "YYYY-yil DD-MMMM")
                : "____-yil __-________"}
              dagi {basic?.request_number || "____"}-son bildirgisiga binoan
              tarmoqda tashkil qilingan asosiy kanallar o‘chirilganligi sababli
              {basic?.deadline
                ? dateFormatter(basic.deadline, "YYYY-yil DD-MMMM")
                : "____-yildan"}{" "}

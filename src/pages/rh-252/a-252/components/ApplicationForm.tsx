        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} action="">
                <div className="p-8 bg-white shadow-lg text-black">
                    ...
                    {/* 17-31 bo'lmasa qolgan inputlar ko'rinadi */}
                    {!isNetworkDocMode && (
                        <>
                            ...
                            <div className="flex items-center gap-2 mt-4">
                                <span className="font-semibold whitespace-nowrap">MBB shakl 3.3:</span>
                                <MyInput
                                    control={form.control}
                            ...
                            {selectedActions.includes("create") && (
                                <div className="flex items-center gap-2 mt-2">
                                    <span className="font-semibold whitespace-nowrap">Mas'ul tashkilot:</span>
                                    <MyInput
                                        control={form.control}

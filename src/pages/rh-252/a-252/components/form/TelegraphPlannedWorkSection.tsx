  ...
  return (
    <div className="">
      ...
      <div className="mt-8">
        ...
        {fields.length === 0 && (
          <div className="flex flex-col items-center justify-center py-8 border-2 border-dashed border-gray-200 rounded-2xl bg-gray-50/50">
            <div className="p-3 bg-white rounded-full shadow-sm mb-3">
              <Info className="w-6 h-6 text-gray-300" />
            </div>
            <p className="text-gray-400 text-sm">
              Hali hech qanday ID kiritilmadi
            </p>
          </div>
        )}
      </div>

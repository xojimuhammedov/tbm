...
const UpdateFlowSection = ({
    ...
    const getValidationStatus = (index: number, field: string): 'valid' | 'invalid' | 'checking' | undefined => {
    ...
    const getInputClassName = (index: number, field: string, baseClassName: string = "") => {
        const key = `update-${index}-${field}`;
                                ...
                                <div className="relative">
                                    ...
                                    <div className="absolute right-2 top-1/2 -translate-y-1/2">
                                        {getValidationStatus(index, "code") === 'checking' && (
                                            <div className="text-blue-500 animate-spin text-xs">⟳</div>
                                        )}

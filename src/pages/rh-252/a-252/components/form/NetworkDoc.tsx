...
import { Plus, Trash2, AlertCircle, CheckCircle, Loader2, Hash } from "lucide-react";
                    ...
                    return (
                        <div
                            ...
                            className={`relative flex items-center gap-2 p-1 pl-3 bg-white border rounded-lg transition-all duration-200 ${
                                status === true ? 'border-green-500 bg-green-50/30' :
                                    status === false ? 'border-red-500 bg-red-50/30' : 'border-gray-200 focus-within:border-blue-400'
                            }`}
                        >

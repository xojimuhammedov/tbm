...
const RHB3_3Application = () => {
  ...
  const { mutate } = usePostQuery({
    listKeyId: "RHF_Application",
  })

  const onSubmit = (data: any) => {
    mutate(
      {
        url: '/api/rh-252/f-app',
        attributes: data
      },
      {
        onSuccess: () => {
        ...
        <div className="w-full max-w-7xl mx-auto p-4">
          ...
          <div className="flex flex-col mb-6">
            <p className="text-center text-sm">
              {t("«Ўзбектелеком» АК филиалларининг фармойишлари асосида алоқаларни ташкил этиш тўғрисида")} <br />
            </p>
        ...
        <table className="border border-gray-300">
          <thead className="bg-gray-100">
            <tr>
              ...
              >
                «Ўзбектелеком» АК филиали
                фармойишининг номери ва сана
              </th>
              <th
                rowSpan={2}
                className="border border-gray-300 px-4 py-3 text-xs text-center"

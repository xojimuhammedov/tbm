...
// // import { F51DocumentInterface } from "@/pages/rh-252/rh-3_3/interfaces/f51Document.interface.ts";

// const statusVariant = (status: F51DocumentInterface["status"]) => {
//   switch (status) {
//     case "approved":
...
// const createF51Columns = (
//   t: (...args: TranslationArgsType) => string,
//   handleEdit: (id: string) => void,
//   handleDelete: (id: string) => void,
//   handleView: (id: string) => void,
// ): ColumnType<F51DocumentInterface>[] => [
//   {
//     key: "channel_id",
...
//     key: "workArea",
//     dataIndex: "workArea",
//     name: t("Ishlar uchastkasi"),
//   },
//   {
//     key: "ubpZone",
//     dataIndex: "ubpZone",
//     name: t("UBP zonasi"),
//     render: (value) => value.map((mbb) => <div key={mbb}>{mbb}</div>),
//   },
//   {
//     key: "minute",
//     dataIndex: "minute",
//     name: t("O'tkazish uchun belgilangan vaqt"),
//   },
//   {
//     key: "description",
...
// export default createF51Columns;

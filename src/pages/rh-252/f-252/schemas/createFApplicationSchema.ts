...
const connectionDataSchema = (t: (...args: TranslationArgsType) => string) =>
    z.object({
        ...
        connection_established_date: z
            .string()
            .min(1, {message: t("Sana majburiy")}),
        connection_route_details: z
            .string()
            .min(1, {message: t("Tafsilotlar majburiy")}),
...
export type FApplicationDto = z.infer<ReturnType<typeof createFApplicationSchema>>;

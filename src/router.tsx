...
const DecreesTbpPage = lazy(() => import("@/pages/tbp-documents/17-96 external inbound document/Page.tsx"));
const DecreesTbpFormPage = lazy(() => import("@/pages/tbp-documents/17-96 external inbound document/pages/FormPage.tsx"));

const NotifyTbpPage = lazy(() => import("@/pages/tbp-documents/17-96 external inbound document/Page.tsx"));
const NotifyTbpFormPage = lazy(() => import("@/pages/tbp-documents/17-96 external inbound document/pages/FormPage.tsx"));

const OutgoingTbpPage = lazy(() => import("@/pages/tbp-documents/17-96 external inbound document/Page.tsx"));
const OutgoingTbpFormPage = lazy(() => import("@/pages/tbp-documents/17-96 external inbound document/pages/FormPage.tsx"));

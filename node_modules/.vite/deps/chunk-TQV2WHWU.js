...
// node_modules/dgz-ui/dist/index-l1ZGtt0d.js
...
function m(...e) {
  return (t) => {
    ...
    const o = e.map((n) => {
      const l = d(n, t);
      return !r && typeof l == "function" && (r = true), l;
    });
    if (r)
      return () => {
...
function g(e) {
  const t = C(e), r = i.forwardRef((o, n) => {
    ...
    if (c) {
      ...
      return ae.jsx(t, { ...a, ref: n, children: i.isValidElement(u) ? i.cloneElement(u, void 0, S) : null });
    }
    return ae.jsx(t, { ...a, ref: n, children: l });
  });
...
function _(e) {
  const t = ({ children: r }) => ae.jsx(ae.Fragment, { children: r });
...
//# sourceMappingURL=chunk-TQV2WHWU.js.map

...
// node_modules/dgz-ui-shared/dist/useColumnsStore-CllOTGkk.js
...
var C = (t, s) => (e, o, a) => {
  ...
  const I = () => {
    ...
    return b(i.getItem.bind(i))(r.name).then((c) => {
      if (c)
        if (typeof c.version == "number" && c.version !== r.version) {
          if (r.migrate) {
            ...
            return l instanceof Promise ? l.then((p) => [true, p]) : [true, l];
          }
          console.error(
      ...
      y == null || y(m, void 0), m = o(), f = true, d.forEach((c) => c(m));
    }).catch((c) => {
      y == null || y(void 0, c);
    });
  };
...
//# sourceMappingURL=chunk-T6Y7KPYU.js.map

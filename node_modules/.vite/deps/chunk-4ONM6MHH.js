...
// node_modules/dgz-ui-shared/dist/index.esm-lbl2HgR1.js
var pe = __toESM(require_react(), 1);
var import_react = __toESM(require_react(), 1);
var de = (e) => e.type === "checkbox";
var re = (e) => e instanceof Date;
var R = (e) => e == null;
var rt = (e) => typeof e == "object";
var D = (e) => !R(e) && !Array.isArray(e) && rt(e) && !re(e);
var Ft = (e) => D(e) && e.target ? de(e.target) ? e.target.checked : e.target.value : e;
var At = (e) => e.substring(0, e.search(/\.\d+(\.|$)/)) || e;
var mt = (e, s) => e.has(At(s));
var xt = (e) => {
  const s = e.constructor && e.constructor.prototype;
  return D(s) && s.hasOwnProperty("isPrototypeOf");
};
var Oe = typeof window < "u" && typeof window.HTMLElement < "u" && typeof document < "u";
function L(e) {
  let s;
...
var z = (e) => typeof e == "boolean";
var Te = (e) => /^\w*$/.test(e);
var st = (e) => Ve(e.replace(/["|']|\]/g, "").split(/\.|\[/));
var m = (e, s, r) => {
  let a = -1;
...
import_react.default.createContext(null);
var wt = (e, s, r, a = true) => {
  const u = {
...
var Dt = typeof window < "u" ? pe.useLayoutEffect : pe.useEffect;
var Y = (e) => typeof e == "string";
var Et = (e, s, r, a, u) => Y(e) ? (a && s.watch.add(e), y(r, e, u)) : Array.isArray(e) ? e.map((n) => (a && s.watch.add(n), y(r, n))) : (a && (s.watchAll = true), r);
var St = (e, s, r, a, u) => s ? {
  ...r[e],
  types: {
...
var N = (e) => D(e) && !Object.keys(e).length;
var Le = (e) => e.type === "file";
...
var Ce = (e) => e.type === "radio";
var kt = (e) => Ce(e) || de(e);
var Se = (e) => ve(e) && e.isConnected;
function Ot(e, s) {
...
function _e(e, s = {}) {
  ...
  if (D(e) || r)
    for (const a in e)
      Array.isArray(e[a]) || D(e[a]) && !at(e[a]) ? (s[a] = Array.isArray(e[a]) ? [] : {}, _e(e[a], s[a])) : R(e[a]) || (s[a] = true);
  return s;
}
function lt(e, s, r) {
...
var Ye = { value: true, isValid: true };
var nt = (e) => {
  if (Array.isArray(e)) {
    if (e.length > 1) {
    ...
    return e[0].checked && !e[0].disabled ? (
      ...
      e[0].attributes && !S(e[0].attributes.value) ? S(e[0].value) || e[0].value === "" ? Ye : { value: e[0].value, isValid: true } : Ye
    ) : ze;
  }
  return ze;
};
var ut = (e, { valueAsNumber: s, valueAsDate: r, setValueAs: a }) => S(e) ? e : s ? e === "" ? NaN : e && +e : r && Y(e) ? new Date(e) : a ? a(e) : e;
var je = {
  isValid: false,
  value: null
};
...
var ue = (e) => S(e) ? e : be(e) ? e.source : D(e) ? be(e.value) ? e.value.source : e.value : e;
var Qe = (e) => ({
...
var Xe = "AsyncFunction";
var Ct = (e) => !!e && !!e.validate && !!(W(e.validate) && e.validate.constructor.name === Xe || D(e.validate) && Object.values(e.validate).find((s) => s.constructor.name === Xe));
var Rt = (e) => e.mount && (e.required || e.min || e.max || e.maxLength || e.minLength || e.pattern || e.validate);
var Ze = (e, s, r) => !r && (s.watchAll || s.watch.has(e) || [...s.watch].some((a) => e.startsWith(a) && /^\.\w+/.test(e.slice(a.length))));
var fe = (e, s, r, a) => {
...
var Ut = (e, s, r) => !e || !s || e === s || oe(e).some((a) => a && (r ? a === s : a.startsWith(s) || s.startsWith(a)));
var Nt = (e, s, r, a, u) => u.isOnAll ? false : !r && u.isOnTouch ? !(s || e) : (r ? a.isOnBlur : u.isOnBlur) ? !e : (r ? a.isOnChange : u.isOnChange) ? e : true;
var Bt = (e, s) => !Ve(y(e, s)).length && T(e, s);
var It = (e, s, r) => {
  const a = oe(y(e, r));
...
function qt(e = {}) {
  ...
  const v = {
    ...
    if (!s.disabled && (x.isValid || E.isValid || t)) {
      const i = s.resolver ? N((await Z()).errors) : await I(a, true);
  ...
  }, Fe = (t, i = [], l, d, f = true, o = true) => {
    if (d && l && !s.disabled) {
      if (c.action = true, o && Array.isArray(y(a, t))) {
    ...
    if (!s.disabled) {
      if (!l || d) {
        ...
        const A = ee(y(u, t), i);
        g = !!y(r.dirtyFields, t), A ? T(r.dirtyFields, t) : m(r.dirtyFields, t, true), V.dirtyFields = r.dirtyFields, o = o || (x.dirtyFields || E.dirtyFields) && g !== !A;
      }
      if (l) {
    ...
    for (const d in t) {
      ...
      if (f) {
        ...
        if (o) {
          ...
          A && x.validatingFields && X([d], true);
          const B = await tt(f, h.disabled, n, ae, s.shouldUseNativeValidation && !i, V);
          if (A && x.validatingFields && X([d]), B[o.name] && (l.valid = false, i))
            break;
    ...
    (l.shouldDirty || l.shouldTouch) && O(t, f, l.shouldTouch, l.shouldDirty, true), l.shouldValidate && se(t);
  }, C = (t, i, l) => {
    for (const d in i) {
    ...
    if (f) {
      ...
      if (!G && De && v.state.next({ ...r }), s.resolver) {
        ...
        X([l], true), A = (await tt(f, h.disabled, n, ae, s.shouldUseNativeValidation))[l], X([l]), o(he), d && (A ? B = false : (x.isValid || E.isValid) && (B = await I(a, true)));
  ...
  }) : _(t, i, true), Ue = (t) => v.state.subscribe({
    next: (i) => {
  ...
  }).unsubscribe, ct = (t) => (c.mount = true, E = {
    ...E,
    ...t.formState
  }, Ue({
    ...t,
    ...
    return m(a, t, {
      ...
      ref: (f) => {
        if (f) {
          ...
          l = y(a, t, {}), l._f && (l._f.mount = false), (s.shouldUnregister || i.shouldUnregister) && !(mt(h.array, t) && c.action) && h.unMount.add(t);
      }
    };
    ...
    h = {
      ...
      isDirty: f ? false : i.keepDirty ? r.isDirty : !!(i.keepDefaultValues && !ee(t, u)),
...
function pt(e = {}) {
  const s = import_react.default.useRef(void 0), r = import_react.default.useRef(void 0), [a, u] = import_react.default.useState({
    isDirty: false,
    isValidating: false,
  ...
  return n._options = e, Dt(() => {
    ...
    return u((h) => ({
      ...h,
      isReady: true
    })), n._formState.isReady = true, c;
  }, [n]), import_react.default.useEffect(() => n._disableForm(e.disabled), [n, e.disabled]), import_react.default.useEffect(() => {
    e.mode && (n._options.mode = e.mode), e.reValidateMode && (n._options.reValidateMode = e.reValidateMode);
  }, [n, e.mode, e.reValidateMode]), import_react.default.useEffect(() => {
    e.errors && (n._setErrors(e.errors), n._focusError());
  }, [n, e.errors]), import_react.default.useEffect(() => {
    e.shouldUnregister && n._subjects.state.next({
      values: n._getWatch()
    });
  }, [n, e.shouldUnregister]), import_react.default.useEffect(() => {
  ...
  }, [n, a.isDirty]), import_react.default.useEffect(() => {
    e.values && !ee(e.values, r.current) ? (n._reset(e.values, n._options.resetOptions), r.current = e.values, u((c) => ({ ...c }))) : n._resetDefaultValues();
  }, [n, e.values]), import_react.default.useEffect(() => {
    n._state.mount || (n._setValid(), n._state.mount = true), n._state.watch && (n._state.watch = false, n._subjects.state.next({ ...n._formState })), n._removeUnmounted();
...
//# sourceMappingURL=chunk-4ONM6MHH.js.map

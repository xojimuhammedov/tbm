...
// node_modules/dgz-ui/dist/index-D_OzDH1f.js
var s = __toESM(require_react(), 1);
function y(n, e, { checkForDefaultPrevented: t = true } = {}) {
  return function(o) {
    if (n == null || n(o), t === false || !o.defaultPrevented)
...
var R = (n) => {
  const { present: e, children: t } = n, r = h(e), o = typeof t == "function" ? t({ present: r.isPresent }) : s.Children.only(t), c = x(r.ref, w2(o));
...
//# sourceMappingURL=chunk-45IG7P76.js.map

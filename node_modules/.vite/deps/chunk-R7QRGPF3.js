// node_modules/dgz-ui/dist/utils-B6fNqzRf.js
function xe(e) {
  var n, r, o = "";
...
var je = (e) => e.endsWith(te) ? e.substring(0, e.length - 1) : e.startsWith(te) ? e.substring(1) : e;
var Oe = (e) => {
...
var ve = /^\((?:(\w[\w-]*):)?(.+)\)$/i;
var Ue = /^\d+\/\d+$/;
var qe = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/;
var He = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/;
var Je = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/;
var Xe = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/;
var De = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/;
var N = (e) => Ue.test(e);
...
var Ce = (e) => e === "position" || e === "percentage";
var Me = (e) => e === "image" || e === "url";
var Se = (e) => e === "length" || e === "size" || e === "bg-size";
var Ae = (e) => e === "length";
var ao = (e) => e === "number";
var io = (e) => e === "family-name";
var Ie = (e) => e === "shadow";
var lo = () => {
...
//# sourceMappingURL=chunk-R7QRGPF3.js.map

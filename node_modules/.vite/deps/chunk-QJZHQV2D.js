...
// node_modules/dgz-ui/dist/button-Bp2lHjov.js
...
var u = (0, import_react.forwardRef)(
  ({ className: e, variant: t, size: i, asChild: r = false, ...o }, s) => {
    const a = r ? j : "button";
    return ae.jsx(
      a,
      {
        className: mo(g({ variant: t, size: i, className: e })),
        ref: s,
        ...o
      }
    );
...
//# sourceMappingURL=chunk-QJZHQV2D.js.map

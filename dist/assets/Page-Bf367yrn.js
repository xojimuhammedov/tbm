import { i as N, q as V, r, j as e } from "./index-ADhmmBpU.js";
...
import { F as v } from "./f51.constants-C9eI1nkf.js";
import { u as q } from "./useF51Document-DMSV6a3I.js";
...
const z = () => {
    ...
    const { t: s } = d(),
      ...
      [i, l] = r.useState(!1),
      [n, u] = r.useState(null),
      { removeWithConfirm: p } = M([v]),
      { query: c, handleFilter: w, params: F } = S({ url: [v] }),
      { f51DocumentQuery: C } = q(n),
      y = r.useCallback(() => {
        t("/gras/b-231/create");
      }, [t]),
      h = r.useCallback(
        ...
        (o) => {
          p(o)
            ...
            .catch((b) => {
              a({
                variant: "destructive",
                title: s(`${j.get(b, "response.statusText", "Error")}`),
                description: s(
                  `${j.get(b, "response.data.message", "An error occurred. Contact the administrator")}`,
                ),
              });
            });
        },
  ...
  K = ({ open: s, onOpenChange: t, document: a }) => {
    const { t: i } = d();
    return e.jsx(L, {
      open: s,
      onOpenChange: t,
      ...
      children: e.jsxs("div", {
        ...
        children: [
          ...
          e.jsx(P, { docType: i("F51"), onOpenChange: t, document: a }),
        ],
      }),
    });
  },
  ue = () => {
    const { t: s } = d(),
      { handleAdd: t, openView: a, currentItem: i, handleCloseView: l } = z(),
      n = r.useMemo(
        () => [
          { name: s("RTSI"), path: "/rtsi", isActive: !1 },
          { name: s("F-51 document"), path: "/rtsi/f-51", isActive: !0 },
        ],
        [s],
      );
    return e.jsxs(e.Fragment, {
      children: [
        e.jsx(K, { open: a, onOpenChange: l, document: i }),
        e.jsx(E, {

import { i as E, q as S, r as a, j as e } from "./index-ADhmmBpU.js";
import { P as T } from "./PageHeader-l3FtlNyv.js";
import { u, c as A } from "./button-Bp2lHjov-bkEUXTzY.js";
...
const Q = () => {
        ...
        (o) => {
          h(o)
            ...
            .catch((j) => {
              t({
                variant: "destructive",
                title: s(`${w.get(j, "response.statusText", "Error")}`),
                description: s(
  ...
  Y = ({ open: s, onOpenChange: r, document: t }) => {
    const { t: i } = u();
    return e.jsx(R, {
      open: s,
      onOpenChange: r,
      ...
      children: e.jsxs("div", {
        ...
        children: [
          ...
          e.jsx($, { docType: i("F56"), onOpenChange: r, document: t }),
        ],
      }),
    });
  },
    ...
    const { t: s } = u(),
      ...
      n = a.useMemo(
        () => [
          ...
          { name: s("F-56 document"), path: "/rtsi/f-56", isActive: !0 },
        ],
        [s],
      );
    return e.jsxs(e.Fragment, {
      children: [
        e.jsx(Y, { open: t, onOpenChange: l, document: i }),
        e.jsx(T, {

import { a as n, m as a, j as d } from "./button-Bp2lHjov-bkEUXTzY.js";
import "./index-ADhmmBpU.js";
const i = d(
  "inline-flex flex-nowrap whitespace-nowrap justify-center items-center border px-2.5 text-body-2xs-medium dark:border [&>svg]:size-3.5 gap-1",
  {
    variants: {
      ...
      size: { sm: "h-5 min-w-5", lg: "h-6 min-w-6" },
      rounded: { default: "rounded-md", full: "rounded-full" },
    },
    defaultVariants: {
      variant: "default",
      rounded: "default",
...
function l({ className: e, variant: r, rounded: t, type: g, size: b, ...o }) {
  return n.jsx("div", {
    className: a(i({ type: g, variant: r, rounded: t, size: b }), e),
    ...o,
  });
}
l.displayName = "Badge";

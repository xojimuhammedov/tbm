...
import { u as v } from "./useF51DocumentForm-CCvW8VtD.js";
import { u as S, a as k } from "./useFlowsOptions-DlABDue9.js";
import { u as c, c as i } from "./button-Bp2lHjov-bkEUXTzY.js";
import { A as O } from "./arrow-left-Bv-o5b3i.js";
import { S as n } from "./MySelect-CDOMHlry-CVNRsqeU.js";
...
const B = ({ id: t, onSave: l, onCancel: a }) => {
    const { t: r } = c(),
      { staffOptions: x } = f(),
      { channelOptions: m } = S(),
      { flowMbbOptions: d } = k(),
      { form: s, handleSubmit: p } = v({ id: t, onSave: l });
    return e.jsx(h, {
      ...s,
      children: e.jsx("form", {
        ...
        children: e.jsxs("div", {
          ...
          children: [
            ...
            e.jsx("h1", {
              ...
              children: r("Hujjat yaratish F-51"),
            }),
            e.jsxs("div", {
                    ...
                    children: [
                      ...
                      e.jsxs("tr", {
                        children: [
                          ...
                          e.jsx("th", {
                            className:
                              "border border-gray-300 px-1 py-1 text-xs font-medium w-10",
                            children: "7",
                          }),
                          e.jsx("th", {
                            className:
                  ...
                  e.jsx("tbody", {
                    children: e.jsxs("tr", {
                      children: [
                        ...
                        e.jsx("td", {
                          className: "border border-gray-300 px-1 py-1 w-20",
                          children: e.jsx(n, {
                            className:
                        ...
                        e.jsx("td", {
                          ...
                          children: e.jsx(n, {
                            ...
                            options: [
                              { label: r("HA"), value: "HA" },
                              { label: r("YO'Q"), value: "YO'Q" },
                            ],
                            placeholder: r("ha/yo'q"),
                          }),
                        }),
                        e.jsx("td", {
                          className: "border border-gray-300 px-1 py-1",

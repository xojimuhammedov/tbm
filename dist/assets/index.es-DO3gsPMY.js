...
import { k as o } from "./createLucideIcon-B950nf2d-ChSZaRdU.js";
const p = () => {
  ...
  return e.jsxs(m, {
    children: [
      ...
      e.jsxs(k, {
        align: "end",
        children: [
          e.jsx(n, { onClick: () => a(r.LIGHT), children: t("Light") }),
          e.jsx(n, { onClick: () => a(r.DARK), children: t("Dark") }),
          e.jsx(n, { onClick: () => a(r.SYSTEM), children: t("System") }),
        ],
      }),
    ],
  });

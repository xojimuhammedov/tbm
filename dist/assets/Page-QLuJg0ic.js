...
import { H as w } from "./index.es-BKLEAvF1.js";
import { F as l } from "./flows.constants-G1-csUmv.js";
import { u as P } from "./useLists-DBTxrMAi.js";
import { S, u as T } from "./useDelete-DMNw96p5.js";
import { M as x } from "./MyTooltip-DPJtpMhP.js";
import { T as b } from "./trash-2-B_r_Bsxl.js";
import { C as A } from "./circle-plus-CJWL5GeC.js";
...
const I = (e, t, r) => [
    ...
    { key: "speed", dataIndex: "speed", name: e("Speed") },
    {
      key: "updated_at",
      ...
      render: (a) =>
        s.jsxs("div", {
          ...
          children: [
            s.jsx(x, {
              content: e("Edit"),
              children: s.jsx(S, { className: "size-4", onClick: () => r(a) }),
            }),
            s.jsx(x, {
              content: e("Delete"),
              children: s.jsx(b, { className: "size-4", onClick: () => t(a) }),
            }),
          ],
        }),
    },
  ...
  M = () => {
    const { t: e } = f(),
      t = k(),
      { removeWithConfirm: r } = T([l]),
      { toast: a } = y(),
      { query: o, handleFilter: d, params: c } = P({ url: [l] }),
      i = n.useCallback(
        (m) => {
          r(m)
            .then(() => {
  ...
  ee = () => {
    const { t: e } = f(),
      ...
      i = n.useMemo(
        () => [{ name: e("Flows(5_1)"), path: "/flows-5_1", isActive: !0 }],
        [e],
      );

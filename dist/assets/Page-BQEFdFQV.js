...
import { u as K, F } from "./useF54Document-SmdNDJqk.js";
...
const $ = () => {
        ...
        (o) => {
          m(o)
            ...
            .catch((v) => {
              a({
                variant: "destructive",
                title: s(`${w.get(v, "response.statusText", "Error")}`),
                description: s(
  ...
  z = ({ open: s, onOpenChange: t, document: a }) => {
    const { t: i } = f();
    return e.jsx(H, {
      open: s,
      onOpenChange: t,
      ...
      children: e.jsxs("div", {
        ...
        children: [
          ...
          e.jsx(L, { docType: i("F54"), onOpenChange: t, document: a }),
        ],
      }),
    });
  },

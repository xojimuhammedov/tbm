import { j as t, i as k, q as N, r } from "./index-ADhmmBpU.js";
...
import { l as A } from "./lodash-BI9_Ro3R.js";
...
const $ = ({ open: e, onOpenChange: a, document: s }) => {
    const { t: l } = m();
    return t.jsx(I, {
      open: e,
      onOpenChange: a,
      ...
      children: t.jsxs("div", {
        ...
        children: [
          ...
          t.jsx(M, { docType: l("Application"), onOpenChange: a, document: s }),
        ],
      }),
    });
  },
  q = () => {
    ...
    const { t: e } = m(),
      ...
      { query: i, handleFilter: b, params: j } = S({ url: [p] }),
        ...
        (o) => {
          d(o)
            ...
            .catch((v) => {
              s({
                variant: "destructive",
                title: e(`${A.get(v, "response.statusText", "Error")}`),
                description: e(
                  `${A.get(v, "response.data.message", "An error occurred. Contact the administrator")}`,
                ),
              });
            });
        },
    ...
    return {
      ...
      columns: D,
      openView: l,
      currentItem: (g = w.data) == null ? void 0 : g.data,
      handleCloseView: y,
    };
  },
  ue = () => {
    const { t: e } = m(),
      { handleAdd: a, currentItem: s, handleCloseView: l, openView: n } = q(),
      c = r.useMemo(
        () => [
          { name: e("RH 231"), path: "/gras", isActive: !1 },
          { name: e("A application"), path: "/gras/a-231", isActive: !0 },
        ],
        [e],
      );
    return t.jsxs(t.Fragment, {
      children: [
        t.jsx($, { open: n, onOpenChange: l, document: s }),
        t.jsx(V, {
